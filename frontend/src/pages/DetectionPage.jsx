...
import RLThresholdPanel from "../components/RLThresholdPanel";
      ...
      <div className="grid grid-cols-1 gap-4 xl:grid-cols-5">
        ...
        <section className="glass-panel rounded-2xl p-4 xl:col-span-3">
          ...
          <div className="mt-3 rounded-xl border border-violet-500/30 bg-violet-500/5 p-3">
            ...
            <p className="text-sm leading-relaxed text-slate-200">{state.ml.reasoning}</p>
          </div>
        </section>
      </div>

      {/* Row 2: RL threshold optimizer */}
      <RLThresholdPanel rl={rl} />
    </div>
  );
}
